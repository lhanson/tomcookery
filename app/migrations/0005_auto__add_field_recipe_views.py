...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recipe.views'
        db.add_column('app_recipe', 'views', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Recipe.views'
        db.delete_column('app_recipe', 'views')
