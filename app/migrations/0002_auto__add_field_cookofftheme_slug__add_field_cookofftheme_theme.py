...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CookoffTheme.slug'
        db.add_column('app_cookofftheme', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'CookoffTheme.theme'
        db.add_column('app_cookofftheme', 'theme', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
        ...
        # Adding M2M table for field photos on 'CookoffTheme'
        db.create_table('app_cookofftheme_photos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cookofftheme', models.ForeignKey(orm['app.cookofftheme'], null=False)),
            ('photo', models.ForeignKey(orm['app.photo'], null=False))
        ))
        db.create_unique('app_cookofftheme_photos', ['cookofftheme_id', 'photo_id'])


    def backwards(self, orm):
        
        # Deleting field 'CookoffTheme.slug'
        db.delete_column('app_cookofftheme', 'slug')

        # Deleting field 'CookoffTheme.theme'
        db.delete_column('app_cookofftheme', 'theme')

        # Removing M2M table for field ingredient on 'CookoffTheme'
        db.delete_table('app_cookofftheme_ingredient')

        # Removing M2M table for field photos on 'CookoffTheme'
        db.delete_table('app_cookofftheme_photos')
    ...
    models = {
        ...
        'app.cookofftheme': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingredient': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['app.Ingredient']", 'null': 'True', 'blank': 'True'}),
