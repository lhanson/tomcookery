...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyProfile.twitterHandle'
        db.add_column('app_myprofile', 'twitterHandle', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MyProfile.twitterHandle'
        db.delete_column('app_myprofile', 'twitterHandle')
