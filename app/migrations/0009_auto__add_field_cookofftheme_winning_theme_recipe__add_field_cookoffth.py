...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CookoffTheme.winning_theme_recipe'
        db.add_column('app_cookofftheme', 'winning_theme_recipe', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='winning_theme_recipe', null=True, to=orm['app.Recipe']), keep_default=False)

        # Adding field 'CookoffTheme.runner_up_theme_recipe'
        db.add_column('app_cookofftheme', 'runner_up_theme_recipe', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='second_theme_recipe', null=True, to=orm['app.Recipe']), keep_default=False)

        # Adding field 'CookoffTheme.third_place_theme_recipe'
        db.add_column('app_cookofftheme', 'third_place_theme_recipe', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='third_theme_recipe', null=True, to=orm['app.Recipe']), keep_default=False)

        # Adding field 'CookoffTheme.winning_ing_recipe'
        db.add_column('app_cookofftheme', 'winning_ing_recipe', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='winning_ing_recipe', null=True, to=orm['app.Recipe']), keep_default=False)

        # Adding field 'CookoffTheme.runner_up_ing_recipe'
        db.add_column('app_cookofftheme', 'runner_up_ing_recipe', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='second_ing_recipe', null=True, to=orm['app.Recipe']), keep_default=False)

        # Adding field 'CookoffTheme.third_place_ing_recipe'
        db.add_column('app_cookofftheme', 'third_place_ing_recipe', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='third_ing_recipe', null=True, to=orm['app.Recipe']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CookoffTheme.winning_theme_recipe'
        db.delete_column('app_cookofftheme', 'winning_theme_recipe_id')

        # Deleting field 'CookoffTheme.runner_up_theme_recipe'
        db.delete_column('app_cookofftheme', 'runner_up_theme_recipe_id')

        # Deleting field 'CookoffTheme.third_place_theme_recipe'
        db.delete_column('app_cookofftheme', 'third_place_theme_recipe_id')

        # Deleting field 'CookoffTheme.winning_ing_recipe'
        db.delete_column('app_cookofftheme', 'winning_ing_recipe_id')

        # Deleting field 'CookoffTheme.runner_up_ing_recipe'
        db.delete_column('app_cookofftheme', 'runner_up_ing_recipe_id')

        # Deleting field 'CookoffTheme.third_place_ing_recipe'
        db.delete_column('app_cookofftheme', 'third_place_ing_recipe_id')
    ...
    models = {
        ...
        'app.cookofftheme': {
            ...
            'runner_up_ing_recipe': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'second_ing_recipe'", 'null': 'True', 'to': "orm['app.Recipe']"}),
            ...
            'runner_up_theme_recipe': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'second_theme_recipe'", 'null': 'True', 'to': "orm['app.Recipe']"}),
            ...
            'third_place_ing_recipe': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'third_ing_recipe'", 'null': 'True', 'to': "orm['app.Recipe']"}),
            ...
            'third_place_theme_recipe': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'third_theme_recipe'", 'null': 'True', 'to': "orm['app.Recipe']"}),
            'winning_ing_recipe': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'winning_ing_recipe'", 'null': 'True', 'to': "orm['app.Recipe']"}),
            ...
            'winning_theme_recipe': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'winning_theme_recipe'", 'null': 'True', 'to': "orm['app.Recipe']"})
        },
        'app.course': {
