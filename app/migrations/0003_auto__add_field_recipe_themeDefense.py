...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recipe.themeDefense'
        db.add_column('app_recipe', 'themeDefense', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Recipe.themeDefense'
        db.delete_column('app_recipe', 'themeDefense')
